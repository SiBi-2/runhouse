...
class Cluster(Resource):
    ...
    def __init__(
        ...
        server_connection_type: Union[str, ServerConnectionType] = None,
        ...
        **kwargs,  # We have this here to ignore extra arguments when calling from from_config
        ...
        if server_connection_type is None:
            self.server_connection_type = ServerConnectionType.NONE
        elif isinstance(server_connection_type, str):
